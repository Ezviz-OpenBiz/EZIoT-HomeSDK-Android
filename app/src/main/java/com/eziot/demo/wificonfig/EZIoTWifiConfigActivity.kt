...
class EZIoTWifiConfigActivity : BaseActivity(), View.OnClickListener {
    ...
    private fun initData(){
        ...
        mGroupInfo = BaseResDataManager.groupInfo

        EZIoTNetConfigurator.getConfigToken(mFamilyInfo?.id.toString(), mGroupInfo?.id.toString(), object:
...
//                    finish()
    ...
    private var mGroupInfo : EZIoTGroupInfo? = null
